...
namespace neweraHPC
{
   ...
   void json_t::reinitialize()
   {
	 ...
	 {
	    int key_pair_id;
	    key_pair = (key_pair_t *)backtrack->search_inorder_num(1, &key_pair_id);
   ...
   nhpc_status_t json_t::close_element()
   {
	 ...
	 return NHPC_FAIL;
      ...
      int key_pair_id;
      key_pair_t *last_key_pair = (key_pair_t *)(*root).search_inorder_num(level, &key_pair_id);
	 ...
	 LOG_ERROR("Invalid close");
      ...
      root->erase_inorder(key_pair_id);
   ...
   nhpc_status_t json_t::add_element(int json_object, const char *input1, const char *input2)
   {
	 ...
	 return NHPC_FAIL;
      ...
      key_pair_t *last_key = (key_pair_t *)(*root).search_inorder_num(level, NULL);
   ...
   nhpc_status_t json_t::build_structure(const char *json_string)
   {
      ...
      key_pair_t *last_key = (key_pair_t *)(*root).search_inorder_num(1, NULL);
